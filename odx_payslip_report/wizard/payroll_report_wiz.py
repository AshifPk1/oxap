...
class PayrollAnalysis(models.TransientModel):
    ...
    def payroll_analysis_open_window(self):
        ...
        return self.env.ref('odx_payslip_report.action_report_hr_payroll').report_action(self, data=data, config=False)
    ...
    def export_xls(self):
        ...
        return {'type': 'ir.actions.report.xml',
                'report_name': 'odx_payslip_report.hr_payslip_report.xlsx',
                'datas': datas,
                'name': 'PaySlip'
                }
