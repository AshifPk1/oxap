...
class InvestigationInvoiceReport(models.Model):
    _name = "surgery.invoice.report"
    ...
    user_currency_price_total = fields.Float(string="Total With Tax", compute='_compute_amounts_in_user_currency',
                                             digits=0)
